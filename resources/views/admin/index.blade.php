          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              ...
              <div class="box bg-success text-center">
                  ...
                  <h6 class="text-white">Title Management</h6>
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              ...
              <a href="{{ route('home.about')}}">  
                <div class="box bg-warning text-center">
                  ...
                  <h6 class="text-white">About Management</h6>
                </div>
              </a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                <div class="box bg-danger text-center">
                  ...
                  <h6 class="text-white">Professional </h6>
                </div>
              </div>
            </div>
            <!-- Column -->
              ...
              <div class="card card-hover">
               <a href="{{ route('home.work')}}"> 
                <div class="box bg-info text-center">
                  ...
                  <h6 class="text-white">Work Management</h6>
                </div>
                </a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
               <a href="{{ route('home.education')}}"> 
                <div class="box bg-danger text-center">
                  <h1 class="font-light text-white">
                    <i class="mdi mdi-receipt"></i>
                  </h1>
                  <h6 class="text-white">Education Management</h6>
                </div>
                </a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
                ...
                <div class="box bg-info text-center">
                  ...
                  <h6 class="text-white">Contact Management</h6>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    <!-- column -->
                    <div class="col-lg-9">
                     <td align="center"><b>{{ Auth::user()->name }}(Me)</b></td>
                ...
                <ul class="list-style-none">
                  ...
                  <li class="d-flex no-block card-body border-top">
                    ...
                    <div>
                      ...
                      >
                      <span class="text-muted"
                        >But already everything was solved. It will backend.</span
                      >
                    </div>
                    <div class="ms-auto">
                      <div class="tetx-right">
                ...
                <div class="tab-content tabcontent-border">
                  <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="p-20">
                      ...
                      <img
                        src="{{ asset('backend/assets/images/background/img4.jpg')}}"
                        class="img-fluid"
                      />
                    </div>
                  </div>
