...
<html dir="ltr" lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="{{ asset('backend/assets/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}"
    />
<style> 
      ...
      <header class="topbar" data-navbarbg="skin5">
        <nav class="navbar top-navbar navbar-expand-md navbar-dark">
          <div class="navbar-header" data-logobg="skin5">
            ...
            <!-- Logo -->
            <!-- ============================================================== -->
            <a class="navbar-brand" target = "_blank" href="{{ route('homepage')}}">
              <!-- Logo icon -->
      ...
      <div class="page-wrapper">
       @yield('admin')
        ...
        <footer class="footer text-center">
          All Rights Reserved by Met-Technologies. Designed and Developed by
          <a href="#">Php Expert</a>.
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
